...
clf_SVM=SVM.SV(df["data"].copy(),"Churn",lda)   #intiate object from SVM Class
clf_Dt=Dtree.DT(df["data"].copy(),"Churn",lda)   #intiate object from Decision Tree Class
clf_naiv=naiv.RF(df["data"].copy(),"Churn",lda)   #intiate object from Naive Bayes Class
